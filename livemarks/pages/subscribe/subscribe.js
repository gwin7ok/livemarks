...
window.addEventListener("load", function () {
  console.log("[Livemarks] subscribe page loaded (window.load)");
  main();
});
...
async function main() {
  ...
  console.log("[Livemarks] subscribe.main feedUrl=", feedUrl);
  ...
  try {
    console.log("[Livemarks] subscribe.main requesting feed from background", feedUrl);
